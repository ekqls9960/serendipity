            ...
            <div class="container">
                <div class="text-center">
	                ...
	                <div class="row text-center">
		                    ...
		                    <div class="col-md-6">
		                        <h4 class="my-3">내 게시물</h4><p class="text-muted">클릭하면 상세보기로 이동합니다.</p>
		                    <br>
		                    <div>
		                     ...
		                     <c:if test="${poemlist == '[]' }">
	                  			<br>
			                   <h5>작성한 게시물이 없습니다.</h5>
			                   <input type="button" class="btn btn-primary btn-md" value="첫 글 작성"  onclick="window.location.href='${pageContext.request.contextPath}/poem/write'">
