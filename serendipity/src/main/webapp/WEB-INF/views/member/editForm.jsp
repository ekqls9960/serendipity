  ...
  <section class="page-section bg-light" id="editForm">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">회원 정보 수정</h2>
                    <h3 class="section-subheading text-muted">세렌디피티 회원 정보 수정 페이지입니다.</h3>
                </div>
              <div class="center">
              	   <form:form class="form-horizontal" modelAttribute="memberEditForm" role="form" method="post" action="${pageContext.request.contextPath}/member/edit">
                ...
                <div class="form-group" id="divPasswordCheck">
                    ...
                    <div class="col-md-10">
                    	<form:password path="confirmPwd" class="form-control" id="confirmPwd" data-rule-required="true" placeholder="(변경을 원하실 때만 입력해주세요.)" maxlength="30" />
